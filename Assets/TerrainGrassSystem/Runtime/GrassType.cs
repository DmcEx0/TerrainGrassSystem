...
namespace TerrainGrassSystem
{
    ...
    {
        [Header("Height")]
        [Min(0f)] public float BaseHeight       = 0.6f;
        [Min(0f)]
        ...
        public float HeightRandomness           = 0.1f;

        [Header("Width")]
        [Min(0f)] public float BaseWidth        = 0.04f;
        [Min(0f)] public float WidthVariance    = 0.01f;
        [Range(0f, 1f)]
        ...
        public float WidthHeightCoupling        = 0f;

        [Header("Shape")]
        [Tooltip("Forward tilt at the blade tip, in radians.")]
        public float BaseTilt                   = 0.35f;
        public float TiltVariance               = 0.15f;
        [Range(0f, 1f)]
        ...
        public float FacingVariance             = 0.5f;
        [Range(0f, 1f)]
        ...
        public float FacingRandomness           = 0f;
